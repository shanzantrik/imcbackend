    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <a class="btn btn-sm btn-primary" style="float:  right;" href="{{ route('add-composts') }}">{{ __('Add Home Compost') }}</a>
                </div>
                    ...
                    <table class="table table-striped table-bordered nowrap" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ $compost['fileName'] }}" target="_blank"><img src="{{ $compost['fileName'] }}" width="200px" height="250px" /></a></td> 
