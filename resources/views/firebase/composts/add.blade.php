        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    {{ __('Add Home Compost Request') }}

                    <a class="btn btn-sm btn-success" style="float: right;" href="{{route('composts-index')}}">Back</a>
                </div>

                <div class="card-body">
                    <form action="{{ route('save-composts')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                          <label>Device Info</label>
                            <select name="device_info" class="custom-select">
